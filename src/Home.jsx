  ...
  return (
    ...
    <div className= "bg-black  w-full z-[-99] md:space-x-96 flex md:flex-row flex-col h-screen  text-white ">
      ...
      <ul className={`flex justify-center md:justify-start space-x-7 md:bg-black bg-white ${glow ? 'glowing-element': 'bg-white'}`}>
        <li className='md:text-6xl text-4xl mt-2 text-orange-600'><a href=''><ion-icon name="logo-linkedin"></ion-icon></a></li>
        <li className='md:text-6xl text-4xl mt-2 text-orange-600'><a href=''><ion-icon name="logo-github"></ion-icon></a></li>
        <li className='md:text-6xl text-4xl mt-2 text-orange-600'><a href=''><ion-icon name="mail-outline"></ion-icon></a></li>
        <li className='md:text-6xl text-4xl mt-2 text-orange-600'><a href=''><ion-icon name="logo-instagram"></ion-icon></a></li>
       </ul>
      </div>
       </div>
      </div>
      <div className='flex w-full md:w-fit justify-center'>
      <img className=' md:w-96 md:h-96 h-60 w-60 mt-5 md:mt-60 'src={vec1} alt=''/>
      </div>
    </div>
    </>
