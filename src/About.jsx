      ...
      <div className="bg-black  w-full z-[-99]  flex md:flex-col flex-col   text-white  font-roberto">
        <div className='w-full flex justify-center'>
          <div className=" mt-28 md:mt-40 flex w-3/4 flex-col font-roberto">
            <div className='text-4xl text-orange-600 mb-3'>Hello, and welcome to my portfolio!</div>
            ...
            <div className='text-4xl text-orange-600 mb-3'>Skills</div>
            <div className='md:flex-row flex-col flex md:space-x-5 md:space-y-0 space-y-4 items-center'>
              <div className='bg-black w-96 h-96 text-white flex flex-col justify-center items-center border-2 border-slate-50'>
        ...
        <div className='w-full flex justify-center'>
          <div className=" mt-7 flex md:w-1/2 w-3/4 flex-col font-roberto border-2 items-center border-slate-50 pt-3 pb-3">
           <div className='text-4xl text-orange-600 mb-3 '>Education</div>
           <sapn className='text-2xl text-orange-600 '> B.E. in Computer Science Engineering:</sapn>Chitkara University - 2021-2025
           <sapn className='text-2xl text-orange-600 mt-3'> Higher Secondary School :</sapn>OP Jindal School, Ramgarh - 2020- 2021
